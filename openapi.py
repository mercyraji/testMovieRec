...
def get_trivia(films):
    prompt = (f"From this list of films watched by a user: {films}, take one film and generate 5 movie trivia questions based on that film with the answer posed as a muliple choice questions include only 3 answers to choose from")
